...
from mkdg.utils.preprocess import del_consonant
from mkdg.utils.preprocess import del_num
...
def frequency(contents):
    ...
    for text in contents:
        ...
        for word in morList:
            ...
            if len(word) >= 2 and word is not "병":  # pass only one character
...
if __name__ == "__main__":
    filename = "20200404060300981.txt"
    path = "./data/" + filename
